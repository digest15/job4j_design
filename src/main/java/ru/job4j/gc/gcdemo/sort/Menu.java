package ru.job4j.gc.gcdemo.sort;

import ru.job4j.gc.gcdemo.sort.data.Data;
import ru.job4j.gc.gcdemo.sort.data.RandomArray;
import ru.job4j.gc.gcdemo.sort.sort.BubbleSort;
import ru.job4j.gc.gcdemo.sort.sort.InsertSort;
import ru.job4j.gc.gcdemo.sort.sort.MergeSort;
import ru.job4j.gc.gcdemo.sort.sort.Sort;
...
public class Menu {
    ...
    public static final String MENU = "Введите 1 для создание массива.\n"
